...
function AdminDashboard() {
    ...
    const selectAllUsers = () => {
        ...
        computeAveragesForAllUsers(); // This assumes you want to compute averages immediately after selecting all
    };
    ...
    const clearAllSelections = () => {
        ...
        setDisplayMessage('No user selected or no histories available');  // Optional: update display message
    };
    ...
    <div>
        ...
        <Grid container spacing={2}>
            ...
            <div className="card">
                ...
                <div className="users">{users.length}</div>
        ...
        <Grid container spacing={2}>
            {u.history.map((item, index) => (
                <Grid item key={index} xs={12} sm={6} md={4}>
                    <Card variant="outlined"  sx={{ height: 350, cursor: 'pointer', backgroundColor: '#f8f9fa'
 }}>
